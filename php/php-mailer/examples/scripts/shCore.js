...
(function (e) {
  function c(e, t) {
    ...
    var n = e._xregexp;
    return (
      (e = XRegExp(e.source, h(e) + (t || ""))), n && (e._xregexp = { source: n.source, captureNames: n.captureNames ? n.captureNames.slice(0) : null }), e
    );
  }
  function h(e) {
    ...
    while (a < t.length)
      (h = p(t, a, u, f)),
        h
          ...
          : ((v = t.charAt(a)), v === "[" ? (u = XRegExp.INSIDE_CLASS) : v === "]" && (u = XRegExp.OUTSIDE_CLASS), s.push(v), a++);
  ...
  var t = /\$(?:(\d\d?|[$&`'])|{([$\w]+)})/g,
    ...
    l = {};
  (l[XRegExp.INSIDE_CLASS] = /^(?:\\(?:[0-3][0-7]{0,2}|[4-7][0-7]?|x[\dA-Fa-f]{2}|u[\dA-Fa-f]{4}|c[A-Za-z]|[\s\S]))/),
    (l[XRegExp.OUTSIDE_CLASS] =
    ...
    (RegExp.prototype.exec = function (t) {
      ...
      if (n) {
        !u &&
          n.length > 1 &&
          d(n, "") > -1 &&
          ((i = RegExp(this.source, o.replace.call(h(this), "g", ""))),
    ...
    (RegExp.prototype.test = function (e) {
      ...
      return (
        ...
        t && !a && this.global && !t[0].length && this.lastIndex > t.index && this.lastIndex--,
    ...
    (String.prototype.replace = function (e, n) {
      var r = XRegExp.isRegExp(e),
        ...
        a;
      return (
        r ? (e._xregexp && (i = e._xregexp.captureNames), e.global || (a = e.lastIndex)) : (e += ""),
    ...
    return (
      ...
      (e.HtmlScript = function (t) {
        ...
        function l(e, t) {
          ...
          a.left != null && e.left != null && ((l = M(e.left, a.left)), f(l, e.index), (s = s.concat(l))),
            a.right != null && e.right != null && ((l = M(e.right, a.right)), f(l, e.index + e[0].lastIndexOf(e.right)), (s = s.concat(l)));
      ...
      (e.Highlighter.prototype = {
        ...
        getCodeLinesHtml: function (t, n) {
          ...
          for (var a = 0; a < r.length; a++) {
            var f = r[a],
              ...
              c = null,
              h = n ? n[a] : o + a;
            l != null && ((c = l[0].toString()), (f = f.substr(c.length)), (c = c.replace(" ", e.config.space))),
              (f = L(f)),
              f.length == 0 && (f = e.config.space),
              (t += this.getLineHtml(a, h, (c != null ? '<code class="' + u + ' spaces">' + c + "</code>" : "") + f));
          }
          return t;
        },
        ...
        getHtml: function (t) {
          var n = "",
            ...
            u;
          return (
            this.getParam("light") == 1 && (this.params.toolbar = this.params.gutter = !1),
            (className = "syntaxhighlighter"),
            this.getParam("collapse") == 1 && r.push("collapsed"),
            (gutter = this.getParam("gutter")) == 0 && r.push("nogutter"),
            r.push(this.getParam("class-name")),
            r.push(this.getParam("brush")),
            (t = E(t).replace(/\r/g, " ")),
            (i = this.getParam("tab-size")),
            (t = this.getParam("smart-tabs") == 1 ? C(t, i) : N(t, i)),
            ...
            typeof navigator != "undefined" && navigator.userAgent && navigator.userAgent.match(/MSIE/) && r.push("ie"),
            (n =
              '<div id="' +
              o(this.id) +
              '" class="' +
              r.join(" ") +
              '">' +
              (this.getParam("toolbar") ? e.toolbar.getHtml(this) : "") +
        ...
        getDiv: function (t) {
          ...
          return (
            ...
            this.getParam("toolbar") && g(l(n, ".toolbar"), "click", e.toolbar.handler),
            this.getParam("quick-code") && g(l(n, ".code"), "dblclick", H),
            n
          );
        },
        init: function (t) {
